...
if ( class_exists( 'WP_Importer' ) ) {
    class Directorist_Import extends WP_Importer {
        ...
        function greet() {
            ...
            echo '<p>'.__( 'Howdy! Upload your Directorist Exported xml file to import the data into the site', 'wordpress-importer' ).'</p>';
...
function directorist_importer_init() {
    ...
    register_importer( 'directorist', 'Directorist', __('Import <strong>Directorist Listings</strong> from a Directorist export file.', 'wordpress-importer'), array( $GLOBALS['directorist_import'], 'dispatch' ) );
}
