...
class ATBDP_Offline_Gateway {
    ...
    public function offline_gateway_settings_submenu($submenus)
    {
        $submenus['offline_gateway_submenu'] =  array(
            'title' => __('Bank Transfer', ATBDP_TEXTDOMAIN),
...
------------------
Please remember that your order maybe cancelled if you do not make your payment within next 72 hours.
KAMAL;
